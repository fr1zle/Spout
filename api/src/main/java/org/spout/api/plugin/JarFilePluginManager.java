...
public class JarFilePluginManager implements PluginManager {
	...
	public JarFilePluginManager(final Engine engine, final PluginSecurityManager manager, final double key) {
		this.engine = engine;
